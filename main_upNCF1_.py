...
import time
import numpy as np
from models.upncf1 import upncf1
...
opath = 'yahooR3/op_upncf1_tuning_u.csv'
dataset = 'yahooR3/'
...
result, topk_prediction, valid_rating_prediction, test_rating_prediction = upncf1(train, validation, test, embeded_matrix=np.empty(0), iteration=50, seed=0, source=None,
