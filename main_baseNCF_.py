...
result, topk_prediction, valid_rating_prediction, test_rating_prediction = ncf(train, validation, test, embeded_matrix=np.empty(0), iteration=500, seed=0, source=None,
