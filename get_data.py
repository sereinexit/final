...
def main(args):
    ...
    user_rating_matrix = load_pandas_without_names(path=args.path, name=args.user, sep=args.sep,
                                                   df_name=args.df_name, value_name='rating')
    test_mat = load_pandas_without_names(path=args.path, name=args.random, sep=args.sep,
                                         df_name=args.df_name, value_name='rating',
...
if __name__ == "__main__":
    ...
    parser.add_argument('-d', dest='problem', default='yhoo/')
